...
public class ProcedurePutOnRingAkhorahil extends ElementsTropMod.ModElement {
	public ProcedurePutOnRingAkhorahil(ElementsTropMod instance) {
		super(instance, 55);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure PutOnRingAkhorahil!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (entity instanceof EntityLivingBase) {
			ItemStack _setstack = new ItemStack(ItemRingOnAkhorahil.block, (int) (1));
