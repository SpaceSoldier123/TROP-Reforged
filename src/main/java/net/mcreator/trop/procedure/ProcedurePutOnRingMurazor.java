...
public class ProcedurePutOnRingMurazor extends ElementsTropMod.ModElement {
	public ProcedurePutOnRingMurazor(ElementsTropMod instance) {
		super(instance, 53);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure PutOnRingMurazor!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (entity instanceof EntityLivingBase) {
			ItemStack _setstack = new ItemStack(ItemRingOnMurazor.block, (int) (1));
