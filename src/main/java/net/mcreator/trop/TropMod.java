 ...
 *
 *    Keep the ElementsTropMod object in this class and all calls to this object
...
public class TropMod {
	...
	@Mod.Instance(MODID)
	public static TropMod instance;
	public ElementsTropMod elements = new ElementsTropMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsTropMod.GuiHandler());
